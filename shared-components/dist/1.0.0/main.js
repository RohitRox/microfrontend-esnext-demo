...
var UIComponentB = Object(external_MFE_GLB_React_["lazy"])(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 3000); })];
            case 1:
                _a.sent();
                return [2 /*return*/, __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, "0Lws"))];
        }
    });
}); });
var UIComponentBLazy = function () {
    return external_MFE_GLB_React_["createElement"]("div", { className: "central-comp" },
        external_MFE_GLB_React_["createElement"](external_MFE_GLB_React_["Suspense"], { fallback: external_MFE_GLB_React_["createElement"]("span", { className: "badge badge-light" }, "Loading UI Component B lazily...") },
